...
public class TestKata2LambdasDeeperDive {
    ...
    public void useBiFunction() {
        ...
        BiFunction<Integer, Integer, Integer> add = (x, y) -> Integer.sum(x,y);
        class MyBiFunction {
...
//          -------------------
        ...
        assertEquals(7, add.apply(integer1, integer2),
    ...
    public void sortNames() {
        ...
        Comparator<Person> nameSorter = (o1, o2) ->  o1.getLastName().compareTo(o2.getLastName());
